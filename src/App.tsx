...
export default function App() {
  ...
  const handleSelectChapter = async (ch: Chapter) => {
    ...
    try {
      ...
      setGuideContent(`エラー：${(e as Error).message}`)
    }
              ...
              <div className="mobile-chapter-bar">
                <button
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(184,48,37,0.4)',
                    borderRadius: 6,
              ...
              <div style={{
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{
                    ...
                    color: 'var(--snow)', letterSpacing: 2,
                    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                  }}>
                    {selectedChapter.title}
                  </div>
                  <div style={{ fontSize: 12, color: 'var(--mist)', fontFamily: "'Noto Sans JP', sans-serif", fontWeight: 300 }}>
                    {selectedChapter.sub}
                  </div>
                </div>
              </div>
              ...
              <div ref={scrollAreaRef} style={{ flex: 1, overflowY: 'auto', padding: '24px 20px' }}>
                ...
                {messages.length > 0 && (
                  <div style={{ marginTop: 32, borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 24 }}>
                    ...
                    {chatLoading && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--mist)', fontSize: 13 }}>
                        <div style={{
                          width: 16, height: 16,
                          border: '2px solid rgba(184,48,37,0.2)',
                          borderTop: '2px solid var(--vermillion)',
